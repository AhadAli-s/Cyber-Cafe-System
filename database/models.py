...
def utc_now():
    """Naive UTC datetime — matches DB columns (TIMESTAMP WITHOUT TIME ZONE).
    Avoids the deprecated datetime.utcnow() while staying naive for consistent comparisons."""
...
class Session(Base):
    ...
    StartTime = Column(DateTime, default=utc_now)
